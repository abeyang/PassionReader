<script>
  ...
  function handleLoad(event) {
    ...
    // Graphic2: on mobile, just loops; desktop is more complex
    if (outerWidth < 768) {
      create({
        mode: "scroll",
        player: "#graphic2",
...
<div class={$styles.container}>
  ...
  <section class={$styles.c_section} id="container1">
    ...
    <!-- need quote -->
      <div class={$styles.quotelong}>
        <h2 class={$styles.h2}>Mark 8:31-34</h2>
        <p class={$styles.p}>Jesus began to teach them that the Son of Man must suffer many things and be rejected by the elders, chief priests and teachers of the law, and that he must be killed and after three days rise again. He spoke plainly about this, and Peter took him aside and began to rebuke him.</p>
        <p class={$styles.p}>But when Jesus turned and looked at his disciples, he rebuked Peter. “Out of my sight, Satan!” he said. “You do not have in mind the things of God, but the things of men.”</p>
        <p class={$styles.p}>Then he called the crowd to him along with his disciples and said: “If anyone would come after me, he must deny himself and take up his cross and follow me.”</p>
      </div>
  ...
  <section class={$styles.c_section} id="container2">
    <!-- graphic -->
    <div class={$styles.c_side}>
      <lottie-player id="graphic2"
              src="pages/discipleship/10-02-cross-heart.json"
              class="h-screen sticky top-0"
              on:load={handleLoad}>
      </lottie-player>
    </div>
