<script>
  ...
  import PagePowerForgiveness from "./PagePowerForgiveness.svelte";
  import PageThief from "./PageThief.svelte";
...
{#if $styles.login.dev || access}
  ...
  <Route path="power-of-forgiveness">
    <PagePowerForgiveness />
  </Route>

  <Route path="i-like-thief">
    <PageThief />
  </Route>
